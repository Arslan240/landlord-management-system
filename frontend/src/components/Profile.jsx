  ...
  return (
    <div className="hover:bg-primary-hover rounded-full flex items-center dropdown dropdown-end pr-2" tabIndex={0} role="button">
      ...
      <ul
        ...
        <li className="hover:bg-primary-hover rounded-md"><Link to={'/dashboard/settings'}>Settings</Link></li>
        <li className="hover:bg-primary-hover rounded-md"><Link to={'/logout'}>Logout</Link></li>
      </ul>
