...
const { getAllProperties, addProperty, getSingleProperty, getPropertyLookup } = require("../controllers/property.controller")
...
router.get("/lookup", authMiddleware, getPropertyLookup)
